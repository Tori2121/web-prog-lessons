var img1 = new Image();
img1.src = "img/2020_1.png";
let img2 = new Image();
img2.src = "img/2020_2.png";
let img3 = new Image();
img3.src = "img/2020_3.png";
let img4 = new Image();
img4.src = "img/2020_4.png";
let img5 = new Image();
img5.src = "img/2020_5.png";
let quest = [img1, img2, img3, img4, img5];
let right_answer = [a8, a3, a5, a4, a2];
let n_r_answ = [7, 2, 4, 3, 1];
...
function fnc1(){
    ...
    if (num_ans == right_answer.length){
        ...
        if (sum > 3){
            rec.innerHTML = "Хороший результат. Хотите пройти еще тест?" + '<a href="index3.html">' + "ЗНО за 2019" + '</a>' + '<a href="index1.html">' + "ЗНО за 2021" + '</a>';
        }
        else if (sum < 2){
            rec.innerHTML = "Результат плохой. Рекомендуем больше практики в чтении текстов. Тесты других годов:" + '<a href="index3.html">' + "ЗНО за 2019" + '</a>' + '<a href="index1.html">' + "ЗНО за 2021" + '</a>';
        }
        else {
            rec.innerHTML = "Результат средний. Рекомендуем больше практики в чтении текстов. Тесты других годов:" + '<a href="index3.html">' + "ЗНО за 2019" + '</a>'+ '<a href="index1.html">' + "ЗНО за 2021" + '</a>' ;
        }
    }
}
